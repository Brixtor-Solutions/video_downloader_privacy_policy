...
function HomePage() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col selection:bg-indigo-100 selection:text-indigo-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-xs text-slate-500 block">Legal & Transparency Portal</span>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-white via-slate-50 to-slate-100 border-b border-slate-200 py-16 sm:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-950 tracking-tight leading-tight">
            Clear, Honest Legal Disclosures for <span className="bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">{APP_NAME}</span>
          </h1>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs sm:text-sm text-slate-500">
            <span className="flex items-center gap-1.5 bg-white border border-slate-200 px-3 py-1.5 rounded-lg font-medium text-slate-700 shadow-sm">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Privacy Policy Card */}
          <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg shadow-slate-200/50 flex flex-col justify-between hover:border-indigo-300 transition-all group">
            <div>
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-600">Privacy & Data Governance</span>
              <h2 className="text-2xl font-bold text-slate-950 mt-1">Privacy Policy</h2>
              ...
              <div className="mt-6 space-y-2.5 pt-4 border-t border-slate-100 text-xs sm:text-sm text-slate-600">
                <div className="flex items-center gap-2">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
              <span className="text-xs text-slate-400">Route: /privacy</span>
              <Link
                to="/privacy"
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-lg shadow-slate-200/50 flex flex-col justify-between hover:border-indigo-300 transition-all group">
            <div>
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-violet-600">Terms of Service</span>
              <h2 className="text-2xl font-bold text-slate-950 mt-1">Terms & Conditions</h2>
              <p className="text-slate-600 text-sm sm:text-base mt-3 leading-relaxed">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
              <span className="text-xs text-slate-400">Route: /terms</span>
              <Link
                to="/terms"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-br from-indigo-900 via-indigo-950 to-slate-950 text-white rounded-3xl p-8 sm:p-12 shadow-xl">
          <div className="max-w-3xl">
            <span className="text-xs font-bold uppercase tracking-widest text-indigo-400">Technical Transparency</span>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10">
              <div className="w-10 h-10 rounded-xl bg-indigo-500/30 flex items-center justify-center text-indigo-300 mb-4 font-bold text-base">
                1
              </div>
          ...
          <div className="mt-8 p-4 rounded-xl bg-amber-400/10 border border-amber-400/20 text-xs sm:text-sm text-amber-200 flex items-start gap-3">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-600 text-sm mt-2">Key legal and privacy answers at a glance</p>
        </div>

        <div className="space-y-4">
          <div className="bg-white p-5 sm:p-6 rounded-xl border border-slate-200">
            <h3 className="font-bold text-slate-900 text-base">Do you keep my downloaded videos on your servers?</h3>
          ...
          <div className="bg-white p-5 sm:p-6 rounded-xl border border-slate-200">
            <h3 className="font-bold text-slate-900 text-base">Are you affiliated with YouTube, Instagram, or TikTok?</h3>
            <p className="mt-2 text-sm text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-5 sm:p-6 rounded-xl border border-slate-200">
            <h3 className="font-bold text-slate-900 text-base">Do I need to sign up or create an account?</h3>
            <p className="mt-2 text-sm text-slate-600 leading-relaxed">
          ...
          <div className="bg-white p-5 sm:p-6 rounded-xl border border-slate-200">
            <h3 className="font-bold text-slate-900 text-base">How can I contact the operator?</h3>
            <p className="mt-2 text-sm text-slate-600 leading-relaxed">
              For any questions regarding privacy, legal terms, or technical matters, reach out to {OPERATOR} directly at{' '}
              <a href={`mailto:${CONTACT_EMAIL}`} className="text-indigo-600 font-semibold underline">
                {CONTACT_EMAIL}
              </a>.
            </p>
          </div>
      ...
      {/* Standard Footer */}
      <footer className="bg-white border-t border-slate-200 mt-auto py-10 text-sm text-slate-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6 border-b border-slate-100">
            ...
            <div className="flex items-center gap-6 text-sm">
              <Link to="/" className="hover:text-indigo-600 transition-colors font-semibold text-indigo-600">Home</Link>
